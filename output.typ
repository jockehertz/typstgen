#include /home/jockehertz/.config/typstgen/lib.typ

 // PREAMBLE
// The orcid image is supposed to be 24px, that is equivalent to 18pt
#let orcid_svg = box(image(bytes("<svg width=\"32\" height=\"32\" fill=\"none\" xmlns=\"http://www.w3.org/2000/svg\">
...
"), width: 18pt, height: 18pt), height: 18pt)

#set document(
  author: "Hertzberg, Joakim",
  title: [TITLE HERE])
#set text(lang: "en")
#set page()
...
#align(center)[
  #title() \
  Hertzberg, Joakim #orcid_svg https://orcid.org/0000-0000-0000-0000 \
